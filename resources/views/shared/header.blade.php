        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
                <form action="{{route('catalog')}}" class="hidden lg:flex gap-3">
                    <input name="s" value="{{request('s')}}" type="search" class="w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition" placeholder="Поиск..." required>
